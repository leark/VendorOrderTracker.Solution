...
namespace VendorOrderTracker.Tests
{
  ...
  public class OrderTests : IDisposable
  {
    ...
    {
      Order order = new Order("", "", 0, new int[1] { 0 });
    ...
    {
      Order order = new Order("Croissants", "", 0, new int[1] { 0 });
    ...
    {
      Order order = new Order("Croissants", "12 Nutella filled, 12 strawberry jam filled", 0, new int[1] { 0 });
    ...
    {
      Order order = new Order("Croissants", "12 Nutella filled, 12 strawberry jam filled", 72, new int[1] { 0 });
